...
def triangle(a, b, angle, height=3, heights=None,
    ...
    centerZ = 0 if (
        center or (center == None and centerXYZ[2]))else max(heightAB, heightBC, heightCA)
    ...
    return polyhedron(points=[pointAB1, pointBC1, pointCA1, pointAB2, pointBC2, pointCA2],
                      faces=[[0, 1, 2], [3, 5, 4], [0, 3, 1], [1, 3, 4], [1, 4, 2],
                                 [2, 4, 5], [2, 5, 0], [0, 5, 3]])
